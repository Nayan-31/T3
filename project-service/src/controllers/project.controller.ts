...
import { createProject, launchProject } from "../services/project.service.js";
import { publishMessage } from "../services/broker.service.js";
...
export async function launchProjectController(
  req: Request,
  res: Response,
  next: NextFunction,
) {
